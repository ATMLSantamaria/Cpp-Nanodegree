...
public:
    ...
    // getter / setter
    ChatLogic *GetChatLogicHandle() { return _chatLogic.get(); } //devuelva puntero pero no cambia ownership
    //std::unique_ptr<ChatLogic> GetChatLogicHandle() { return std::move(_chatLogic); } //he generado un seg fault epico
    // events
