    ...
    : wxScrolledWindow(parent, id)
{
    ...
    _chatLogic = std::make_unique<ChatLogic>(); //this option seems less verbose
    //_chatLogicc = std::unique_ptr<ChatLogic>(new ChatLogic()); //this option also valid
...
ChatBotPanelDialog::~ChatBotPanelDialog()
{
    ...
    //delete _chatLogic; -> unique_ptr does not need to be deleted
